...
model.add(Conv2D(4, (5, 5), input_shape=(28, 28, 1), padding='same', activation='relu'))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig("/content/drive/My Drive/code workshop/ANN-Loss_drop.png", bbox_inches="tight", dpi=600)
plt.show()
#précision
plt.clf()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("/content/drive/My Drive/code workshop/ANN-Accuracy_drop.png", bbox_inches="tight", dpi=600)
