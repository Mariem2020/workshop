...
plt.ylabel('Loss')
plt.legend()
plt.savefig("/content/drive/My Drive/code workshop/ANN-Loss_lrdec.png", bbox_inches="tight", dpi=600)
plt.show()
#précision
plt.clf()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("/content/drive/My Drive/code workshop/ANN-Accuracy_lrdec.png", bbox_inches="tight", dpi=600)
